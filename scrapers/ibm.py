"""
IBM Security Advisories scraper
"""
import re
...
class IBMScraper(RSSScraper):
    """Scraper for IBM Security Advisories"""
    ...
    def scrape_vulnerabilities(self) -> List[Dict[str, Any]]:
        ...
        if vuln_url:
            ...
            if soup:
                vulnerabilities.extend(self.parse_ibm_page(soup))
        
        return vulnerabilities
    
    def parse_ibm_page(self, soup) -> List[Dict[str, Any]]:
        """Parse IBM security advisories page"""
        vulnerabilities = []
        ...
        try:
            ...
            for cve_text in cve_texts:
                try:
                    ...
                    logger.error(f"Error parsing IBM CVE: {e}")
                    continue
        
        except Exception as e:
            logger.error(f"Error parsing IBM page: {e}")
